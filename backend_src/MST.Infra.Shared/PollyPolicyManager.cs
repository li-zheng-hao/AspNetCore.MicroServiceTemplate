...
public class PollyPolicyManager
{
    ...
    /// </summary>
    /// <returns></returns>
    public static List<IAsyncPolicy<HttpResponseMessage>> GenerateDefaultPolicies(IWebHostEnvironment environment)
    {
        //隔离策略
        ...
        {
            retryPolicy, timeoutPolicy, circuitBreakerPolicy.AsAsyncPolicy<HttpResponseMessage>()
        };
    }
